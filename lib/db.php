...
/**
 * Fresh-install schema only (CREATE IF NOT EXISTS). Old DB files are not altered.
 * If we need to change schema against live data again, reintroduce incremental
 * migrations here (PRAGMA/ALTER/backfill) alongside or after these CREATEs.
 */
function ensure_schema(PDO $pdo): void
{
    $pdo->exec("CREATE TABLE IF NOT EXISTS tournaments (
        ...
        first_five_round_pot INTEGER NOT NULL DEFAULT 0,
        starting_first_five_round_pot INTEGER NOT NULL DEFAULT 0,
        ...
        up_next_player_id INTEGER DEFAULT NULL,
        current_turn_started_at TEXT DEFAULT NULL,
        current_turn_expires_at TEXT DEFAULT NULL,
        break_started_at TEXT DEFAULT NULL,
        current_cycle_number INTEGER NOT NULL DEFAULT 1,
        paused INTEGER NOT NULL DEFAULT 0,
        round_complete INTEGER NOT NULL DEFAULT 0,
        hide_out_players INTEGER NOT NULL DEFAULT 0,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS players (
        ...
        first_five_amount INTEGER NOT NULL DEFAULT 0,
        main_pot_amount INTEGER NOT NULL DEFAULT 0,
        created_at TEXT NOT NULL,
